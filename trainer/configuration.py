...
class OptimizerConfig:
    ...
    weight_decay: float = 5e-3 #1e-3  # amount of additional regularization on the weights values
...
class TrainerConfig:
    ...
    epoch_num: int = 80  # number of times the whole dataset will be passed through the network
